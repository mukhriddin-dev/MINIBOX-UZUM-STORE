            ...
            px] w-full p-4 pb-0 rounded-lg"
                    >
                        <div className="flex items-center justify-between mb-[20px]">
                            <div className="flex items-center gap-2">
                                ...
                                <label className="text-[13px] select-none cursor-pointer" htmlFor="check">
                                    Hammasini tanlash
                                </label>
                            </div>
                    ...
                    <div className="border border-1 p-[20px] flex-grow rounded-lg">
                                ...
                                {price >= 500000 ? (
                                    <>
                                        <h2 className="text-[14px] leading-[18px]">
                                            ...
                                            <strong className="ml-[5px]">bepul yetkazib berish mavjud</strong>
                                        </h2>
                                    ...
                                    <>
                                        <h2 className="text-[14px] leading-[18px]">
                                            <strong className="mr-[5px]">Buyurtmangizni rasmiy topshirish</strong>
                        ...
                        <div className="flex flex-col items-start">
                            <h2 className="mb-[18px] text-[#212121] font-medium">Buyurtmangiz</h2>
